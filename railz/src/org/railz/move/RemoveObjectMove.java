...
/**
 * Supersedes RemoveItemFromListMove
 * @author bob
 */
class RemoveObjectMove implements ObjectMove {
    ...
    protected RemoveObjectMove(ObjectKey2 key, WorldObject item) {
        objectKey = key;
        this.item = item;	
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof RemoveObjectMove) {
            RemoveObjectMove test = (RemoveObjectMove) o;
